            ...
            <div class="pcb-head">
                ...
                <div class="actions">
                    <div class="all-actions">
                        ...
                        <form action="{{ url('pc_builder/base64_to_image') }}" target="_blank" method="post" id="form-base64-image">
                            <input type="hidden" name="image" id="input-base64-image" value="">
                ...
                <div class="pcb-content">
                    ...
                    <div class="c-item selected">
                        ...
                        <div class="item-price">
                            ...
                            @php
                                Session::put('CPU_price', $data_2->Price );
                   ...
                   <div class="c-item blank">
                    ...
                    <div class="c-item selected">
                        ...
                        <div class="item-price">
                            <div class="price">{{ $data_2->Price }} ৳</div>
                             @php
                                Session::put('CPU_Cooler_price', $data_2->Price );
                    ...
                    <div class="c-item selected">
                        ...
                        <div class="item-price">
                            <div class="price">{{ $data_2->Price }} ৳</div>
                             @php
                                Session::put('Mother_Board_price', $data_2->Price );
                    ...
                    <div class="c-item selected">
                        ...
                        <div class="item-price">
                            <div class="price">{{ $data_2->Price }} ৳</div>
                             @php
                                Session::put('RAM_price', $data_2->Price );
                    ...
                    <div class="c-item selected">
                        ...
                        <div class="item-price">
                            <div class="price">{{ $data_2->Price }} ৳</div>
                             @php
                                Session::put('RAM_2_price', $data_2->Price );
                    ...
                    <div class="c-item selected">
                        ...
                        <div class="item-price">
                            <div class="price">{{ $data_2->Price }} ৳</div>
                             @php
                                Session::put('Storage_price', $data_2->Price );
                    ...
                    <div class="c-item selected">
                        ...
                        <div class="item-price">
                            <div class="price">{{ $data_2->Price }} ৳</div>
                             @php
                                Session::put('Storage_2_price', $data_2->Price );
                    ...
                    <div class="c-item selected">
                        ...
                        <div class="item-price">
                            <div class="price">{{ $data_2->Price }} ৳</div>
                             @php
                                Session::put('Graphics_Card_price', $data_2->Price );
                    ...
                    <div class="c-item selected">
                        ...
                        <div class="item-price">
                            <div class="price">{{ $data_2->Price }} ৳</div>
                             @php
                                Session::put('Power_Supply_price', $data_2->Price );
                    ...
                    <div class="c-item selected">
                        ...
                        <div class="item-price">
                            <div class="price">{{ $data_2->Price }} ৳</div>
                             @php
                                Session::put('Casing_price', $data_2->Price );
                    ...
                    <div class="c-item selected">
                        ...
                        <div class="item-price">
                            <div class="price">{{ $data_2->Price }} ৳</div>
                             @php
                                Session::put('Casing_Cooler_price', $data_2->Price );
                    ...
                    <div class="c-item selected">
                        ...
                        <div class="item-price">
                            <div class="price">{{ $data_2->Price }} ৳</div>
                             @php
                                Session::put('Monitor_price', $data_2->Price );
                    ...
                    <div class="c-item selected">
                        ...
                        <div class="item-price">
                            <div class="price">{{ $data_2->Price }} ৳</div>
                             @php
                                Session::put('Keyboard_price', $data_2->Price );
                    ...
                    <div class="c-item selected">
                        ...
                        <div class="item-price">
                            <div class="price">{{ $data_2->Price }} ৳</div>
                             @php
                                Session::put('Mouse_price', $data_2->Price );
                    ...
                    <div class="c-item selected">
                        ...
                        <div class="item-price">
                            <div class="price">{{ $data_2->Price }} ৳</div>
                             @php
                                Session::put('Headphone_price', $data_2->Price );
                    ...
                    <div class="c-item selected">
                        ...
                        <div class="item-price">
                            <div class="price">{{ $data_2->Price }} ৳</div>
                             @php
                                Session::put('Anti_Virus_price', $data_2->Price );
                    ...
                    <div class="c-item selected">
                        ...
                        <div class="item-price">
                            <div class="price">{{ $data_2->Price }} ৳</div>
                             @php
                                Session::put('UPS_price', $data_2->Price );
