...
<section class="after-header p-tb-10">
        <div class="container">
            <ul class="breadcrumb" itemscope itemtype="">
                ...
                <li>
                    <a itemprop="item" href="{{ url('products/'.$data2->cat_name."/".$data1->sub_cat_name."/".$data3->slug) }}">
                        <span itemprop="name">{{ $data3->brand_name }}</span>
                     </a>
                </li>
            </ul>
        </div>
                    ...
                    <div class="top-bar ws-box">
                        <div class="row">
                            <div class="col-sm-4 col-xs-2 actions">
                                <h6 class="page-heading">{{ $data3->brand_name }}</h6>
                            </div>
