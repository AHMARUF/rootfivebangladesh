        ...
        <div class="container">
            <ul class="breadcrumb" itemscope itemtype="">
                ...
                <li itemprop="itemListElement" itemscope itemtype="">
                    <a itemtype="" itemprop="item" href="{{ url('accessories/products/'.$data->slug
                ) }}"><span itemprop="name">{{ $data->cat_name }}</span></a>
            ...
            <div class="child-list">
                ...
                <a href="{{ url('products/'.$data->cat_name."/".$row->slug) }}">{{ $row->sub_cat_name }}</a>
                @endforeach
            </div>
        </div>
    </section>
                    ...
                    <div class="top-bar ws-box">
                        <div class="row">
                            <div class="col-sm-4 col-xs-2 actions">
                                <h6 class="page-heading">{{ $data->cat_name }}</h6>
                            </div>
